...
export const b_eecs1 = HIDDEN; // "Provided groups of 15-20 with practice problems on data structures, preparing them for midterm exams";

export const b_ieee1 = HIDDEN; // "Used Adobe Photoshop and Illustrator to design promotional stickers, semesterly organization shirt, and new club logo";
...
export const b_amz02 = HIDDEN; // "Leveraged Git and IntelliJ for efficient version control and collaboration within cross-functional teams working in an Agile environment";
...
export const b_amz04 = HIDDEN; // "Configured backend infrastructure using CDK and Typescript, and wrote business logic using singleton dependency injection design pattern and Java";
...
export const b_amz08 = HIDDEN; // "Implemented clean code, code refactoring, and code review best practices, ensuring high code quality and maintainability";
export const b_amz09 = "Added a new SNS topic and DLQ to alarm on bounced emails to keep feature reliable and maintainable";
export const b_amz10 = HIDDEN; // "Added procedures in runbook for handling edge cases of bounced emails and inactive users";
...
export const b_nim02 = HIDDEN; // "Organized tasks and tickets using Atlassian JIRA, and meeting notes and feedback using Confluence";
...
export const b_nim05 = HIDDEN; // "Delegated large code changes with other interns and reviewed their pull requests using Bitbucket";
...
export const b_nim07 = HIDDEN; // "Monitored SQS Cloudwatch monitors after deploying new release, catching and resolving a throttle before severely affecting user end of production";
...
export const b_flwd1 = HIDDEN; // "Designed personal webpage UI mockups using Illustrator, implemented using React.js";
export const b_flwd2 = HIDDEN; // "Planned, implemented, and completed Atom Visualizer and Pentaquad personal projects";
...
export const b_atom1 = HIDDEN; // "Used Numpy to implement pilot wave formulation of Schrodinger's equation for a pointcloud";
export const b_atom2 = HIDDEN; // "Created camera function and rotation to map 3d pointcloud to 2d with perspective";
...
export const b_chat1 = HIDDEN; // "Created a React component and state to recursively upload and display folders in app sidebar";